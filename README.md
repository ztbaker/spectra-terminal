...
- [**macOS (Apple Silicon)**](https://github.com/ztbaker/spectra-terminal/releases/latest) — `.dmg`
- [**Windows**](https://github.com/ztbaker/spectra-terminal/releases/latest) — `.exe`
