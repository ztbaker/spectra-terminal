...
export const RELEASE_NOTES: ReleaseNote[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Login, MFA, push approval, and SMS/email challenge all handled directly from your machine.',
      'Equity history chart and holdings sync work reliably without backend proxy.',
    ],
  },
  {
    version: '1.2.0',
  ...
  },
  {
    ...
    date: '2026-04-21',
    highlights: [
      'New TRUMP command: view Trump\'s latest Truth Social posts in a Bloomberg-style feed with engagement stats.',
      'Options chain now shows Call/Put volume ratio — green when calls dominate, red when puts dominate.',
    ],
  },
  {
    version: '1.1.11',
